...
CRONTAB_COMMAND_PREFIX = 'DJANGO_SETTINGS_MODULE=ConnectedCustomerPlatform.settings_dev'
...
USERMGMT_AUTH_URL = 'https://dev.ce.vassardigital.ai/um/multi-resource-auth'
